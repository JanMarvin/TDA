...
TDA 6.4 (Rohwer and Pötter, last release 6.4p of March 2009) compiled into
the package and run in-process; the build carries the banner 6.4q because
of the repairs listed in `doc/changes-from-tda.md` of the source
repository.
...
in R; the readers for zoo archives, SPSS, Stata, Excel, DBF, ArcInfo
E00 and shapefiles.
