...
#
# The original's "@141" (TDA's escape for a special
# character, drawn through the standard Adobe Symbol font -- alpha,
# checked against the real, unmodified plot14.ps) is used
# directly here, the same way the source itself writes it.
library(tdaR)
