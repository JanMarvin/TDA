...
out. Everything else is reachable with [`tda_pl`](tda_pl.md).
...
- ...:
  ...
  [`tda_help()`](tda_help.md), e.g. `tda_help("ploth")` for
  `tda_pl_histogram`; see [`tda_pl`](tda_pl.md).
